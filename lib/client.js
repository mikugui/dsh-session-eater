		...
		function SettingsSection(props) {
			...
			return jsxs("div", {
				...
				children: [
					...
					jsxs("div", { className: "dse-cfg-block", children: [
						jsx("h3", { children: "删除前确认" }),
						jsx(Toggle, {
							label: "拖上去先问一句", checked: cfg.confirm.enabled,
							onChange: (enabled) => updateConfig({ confirm: { enabled } })
						}),
						jsx("div", {
							className: "dse-cfg-hint",
							children: cfg.confirm.enabled
								? "松手后会停在会话列表里问「确定要删除这个会话吗？」，点「删除」才真吃；按 Esc 或点「取消」什么都没发生。"
								: "已关掉：松手立刻吃掉（旧行为）。想找回确认，把上面那个开关打开。"
						})
					] }),
